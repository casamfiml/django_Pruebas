...
{ 
	...
	if(clicked == 0)
	{
		...
		google.maps.event.addListener(marker, 'dragend', function (evt) {
			//Cambios de 24/01/2018
			//
			//Bryan Ortiz Clau
			latitud.innerHTML = evt.latLng.lat();
			console.log(evt.latLng.lat());

			longitud.innerHTML = evt.latLng.lng();
...
function imagePin()
{
	...
	//Para Heroku
	//url: 'https://fwa-demo.herokuapp.com/static/imgs/logo-mini.png',
	//Para Google Drive
	//url:'https://www.tendencias21.net/telefonica/photo/art/default/16830429-21475001.jpg?v=1505129618',
